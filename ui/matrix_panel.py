# ui/matrix_panel.py W-Matrix visualisation: bracket-style matrix (like the textbook screenshot) with a 3D heatmap colouring based on |W^(nk)| and ∠W^(nk). Layout: ┌──────────────────────────────────────────────┐ │ X(0) ┐ ┌ W^0 W^0 W^0 W^0 ┐ ┌ x(0) ┐ │ X(1) │ = │ W^0 W^1 W^2 W^3 │ │ x(1) │ │ X(2) │ │ W^0 W^2 W^4 W^6 │ │ x(2) │ │ X(3) ┘ └ W^0 W^3 W^6 W^9 ┘ └ x(3) ┘ └──────────────────────────────────────────────┘ Below: magnitude heatmap strip + phase heatmap strip
